...
paperweight {
    serverProject = project(":coco-paper-server")
    ...
    usePaperUpstream(providers.gradleProperty("paperRef")) {
        withPaperPatcher {
            ...
            apiOutputDir = layout.projectDirectory.dir("coco-paper-api")

            serverPatchDir = layout.projectDirectory.dir("patches/server")
            serverOutputDir = layout.projectDirectory.dir("coco-paper-server")
...
tasks.generateDevelopmentBundle {
    apiCoordinates = "world.estaria.coco.paper:coco-paper-api"
